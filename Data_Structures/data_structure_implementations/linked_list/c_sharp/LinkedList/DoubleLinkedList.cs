...
public class DoubleNode<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleNode{T}"/> class with the specified value.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleNode{T}"/> class with the specified value, next node, and previous node.
    /// </summary>
...
public class DoubleLinkedList<T>
{
    ...
    public bool AddBefore(T value, T after)
    {
        ...
        while (current != null)
        {
            ...
            {
                DoubleNode<T> newNode = new DoubleNode<T>(value, current, current.Previous);
    ...
    public bool AddAfter(T value, T before)
    {
        ...
        while (current != null)
        {
            ...
            {
                DoubleNode<T> newNode = new DoubleNode<T>(value, current.Next, current);
